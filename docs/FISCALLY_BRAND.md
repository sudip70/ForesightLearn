...
| **Loan** | `--loan` / `--loan-soft` / `--loan-deep` | `#c96a2e` / `#f5ddc9` / `#9c4f20` | Its own Loan Accounts section in My Accounts (below Investing), the Loan Calculator, the Mortgage Calculator. A deeper, more burnt shade than Spending — same orange family, but distinguishable as their own thing. |

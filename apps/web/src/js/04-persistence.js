...
function saveState(){
  try{localStorage.setItem(STORE_KEY,JSON.stringify({v:1,onboarded:onboarded,PF:PF,ACTIVITY:ACTIVITY,GOAL:GOAL,LEARN:LEARN,contrib:contrib,seen:seen,initDone:initDone,SIM:SIM,BUDGET:BUDGET,GOALS:GOALS,SPENDING:SPENDING,NETWORTH:NETWORTH,LOANS:LOANS,SAVINGS:SAVINGS,CHEQUING:CHEQUING,CREDIT_CARD:CREDIT_CARD,pfLevel:pfLevel}));}catch(e){}
}
function loadState(){
  try{

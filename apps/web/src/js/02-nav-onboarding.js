...
function show(id){
  ...
  var isSub=['scenario','risk','stockfinder','budget','goals','spending','networth','accounts','loan-calc','mortgage-calc','game-swipe','game-wnb','game-scam','game-wordle','game-xword','game-quiz','game-hangman','game-invest'].indexOf(id)>=0;
